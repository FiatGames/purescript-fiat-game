...
_ReadMessage :: Prism' ToServer Int
_ReadMessage = prism' ReadMessage f
  where
    f (ReadMessage a) = Just $ a
    f _ = Nothing

--------------------------------------------------------------------------------
newtype ToClient =
    Messages {
      msgs :: Array ChatMessageDetail
    }
...
--------------------------------------------------------------------------------
_Messages :: Iso' ToClient { msgs :: Array ChatMessageDetail}
_Messages = _Newtype
